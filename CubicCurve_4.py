...
# get strings
tooltip = Silk_tooltips.CubicCurve_4_baseTip + Silk_tooltips.standardTipFooter
moreInfo = Silk_tooltips.CubicCurve_4_baseTip + Silk_tooltips.CubicCurve_4_moreInfo
...
class CubicCurve_4:
    def Activated(self):
        ...
        if len(sel) == 1:
            ...
            a = App.ActiveDocument.addObject("Part::FeaturePython", "CubicCurve_4_000")
    ...
    def GetResources(self):
        return {"Pixmap": iconPath, "MenuText": "CubicCurve_4", "ToolTip": tooltip}
